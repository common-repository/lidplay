        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                    ...
                    <td>
                        <ul class="providers">
                            <?php foreach (lidplay_providers() as $key => $values): ?>
                                <li><label><input type="checkbox" name="lidplay_provider_<?= $key ?>" value="1" <?php checked(get_option('lidplay_provider_' . $key), 1); ?> /> <?= $values['label'] ?></label></li>
                            <?php endforeach; ?>
                        </ul>
                    </td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <label><input type="checkbox" name="lidplay_collection" value="1" <?php checked(get_option('lidplay_collection'), 1); ?> /> <?php _e('Allow the plugin to create a video collection of your site?', 'lidplay') ?></label><br>
                        <p  class="description">
                            <?php _e('In the absence of a video, you will receive random video from the collection of your site.', 'lidplay') ?><br>
                            <?php _e('Enabling this setting allows you to significantly reduce the number of failure rate on the site.', 'lidplay') ?>
                        </p>
                    </td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <label><input type="checkbox" name="lidplay_domain" value="1" <?php checked(get_option('lidplay_domain'), 1); ?> /> <?php _e('Use your own domain for the player', 'lidplay') ?></label><br>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <p>
                        <h4><?php _e('Subtitles (VTT, CORS)', 'lidplay') ?>:</h4>
                        <code>&lt;iframe src="..." <strong>subtitles_src</strong>="//example.com/own-subtitles.vtt" <strong>subtitles_label</strong>="<?php _e('Own label', 'lidplay') ?>" allowfullscreen&gt;&lt;/iframe&gt;</code>
                        </p>
                        <p>
            ...
            <p><?php _e('If you have any questions or suggestions please contact us on', 'lidplay') ?> <a href="https://lidplay.net/#feedback" target="_blank">lidplay.net/#feedback</a></p>
...
function lidplay_js_loader() {
    wp_enqueue_script('lidplay', plugins_url('loader.js', __FILE__), array(), '1.0.5');
}
...
function lidplay_providers() {
    return array(
        ...
        'adult' => array(
            'url_parts' => array('embed.redtube.com', 'xhamster.com', 'flashservice.xvideos.com', 'www.xvideos.com', 'www.porn.com', 'www.pornhub.com', 'www.youporn.com', 'www.tube8.com', 'player.tnaflix.com'),
            'label' => 'Adult (Redtube.com, xHamster.com, xVideos.com, Porn.com, Pornhub.com, Youporn.com, Tube8.com, Tnaflix.com)',
        ),
    );
}
